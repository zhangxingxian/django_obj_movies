...
class TFilm(models.Model):
    ...
    loc_id = models.ForeignKey('TLoc', on_delete=models.DO_NOTHING, blank=True, null=True)
    name = models.CharField(max_length=255, blank=True, null=True)
    ...
    sub_class_id = models.ForeignKey('TSubclass', on_delete=models.DO_NOTHING, blank=True, null=True)
    type_name = models.CharField(max_length=255, blank=True, null=True)
    type_id = models.ForeignKey('TType', on_delete=models.DO_NOTHING, blank=True, null=True)
